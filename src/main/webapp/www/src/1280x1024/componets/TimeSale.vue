<template>
  <div id="timesale" class="c-timesale">
    <div class="c-timesale-total">
      <div style="">累计实时销售额:</div>
      <div class="c-timesale-num">{{animatedNumber}}<span class="c-timesale-nuit">元</span></div>
    </div>
    <div class="c-timesale-t">
      <div style="">目标销售额:</div>
      <div class="c-timesale-t-n">{{target_num}}<span class="">元</span></div>
    </div>
    <div id="timesale-complete" class="c-timesale-complete">
...
.c-timesale .c-timesale-total{
  font-size: 14px;
  color:#4054d6;
  font-weight: bold;
}
.c-timesale .c-timesale-num{
  letter-spacing:2px;
  font-size: 26px;
  color:white;
}
.c-timesale-total span{
  color:#4054d6;
  font-weight:normal;
  font-size:18px;
}
.c-timesale .c-timesale-t{
  font-size: 12px;
  color:#4054d6;
  font-weight: bold;
}
.c-timesale .c-timesale-t-n{
  letter-spacing:1px;
  font-size: 14px;
  color:white;
}
